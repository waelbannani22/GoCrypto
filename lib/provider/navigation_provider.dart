...
enum NavigationBarEvent { LOGIN, HOME, SEARCH, SETTINGS, FAVOURITE }

class NavigationNotifier extends StateNotifier<PageModel> {
  NavigationNotifier() : super(defaultPage);

  static const defaultPage = PageModel(NavigationBarEvent.LOGIN, 0);

  void selectPage(int i) {
    switch (i) {
      case 0:
        state = PageModel(NavigationBarEvent.LOGIN, i);
        break;
      case 1:
